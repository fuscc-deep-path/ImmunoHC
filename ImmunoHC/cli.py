...
"""Console script for ImmunoHC."""


import click
import sys
from ImmunoHC.single_prediction import start_model as start_prediction_model
from ImmunoHC.single_heatmap import make_heatmap as start_single_heatmap
